...
| constant | value | line | note |
| --- | --- | --- | --- |
| `kConnectRadiusMax` | `12` | 2763 | == connectcfg::kMaxRadius (static_assert at the seam in main.cpp) |
| `kIntFlagMax` | `1000000000` | 2762 | parsePosInt/parseNonNegInt's own overflow ceiling |
